	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="team text-center col-sm-8">
				<h2 style="font-family: 'Atomic Age', cursive;">Our Team</h2>
				...
				<div class="select" id="joy">
					<div class="name text-center text-uppercase"><?php echo author_name ; ?></div>
					<div class="sub text-center text-uppercase"><?php echo author_designation ; ?>r</div>
					<span class="line"></span>
					<p class="text-justify">
                    <?php echo about_author ;?>
                    </p>
					<a class="custombtn" href="<?php echo author_facebook;?>" target="_blank">
						<i class="fab fa-facebook-f"></i>
					</a>
					<a class="custombtn" href="<?php echo author_twitter;?>" target="_blank">
						<i class="fab fa-twitter"></i>
					</a>
					<a class="custombtn" href="<?php echo author_google;?>">
						<i class="fab fa-google"></i>
					</a>
					<a class="custombtn" href="<?php echo author_instagram;?>">
						<i class="fab fa-instagram"></i>
					</a>
					<a class="custombtn" href="<?php echo author_youtube;?>">
