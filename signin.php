	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-4 log_css">
				<h2 class="text-center" style="font-family: 'Atomic Age', cursive;" >Sign in</h2>
					<?php 
				...
				<form action="confirm.php" method="POST">
					...
					<input type="Submit" class="btn btn-outline-primary" name="signin" value="Sign In" onclick="a()">
